<template>
  <el-dialog title="折扣抹零" v-model="dialogVisible" :before-close="handleClose" :close-on-click-modal="false"
    ...
    <div class="dialog-content changeProduct">
      ...
      <div class="mb30 d-s-c" v-if="type==3">
        <el-radio-group v-model="discountType">
          <el-radio :value="1">抹分</el-radio>
          <el-radio :value="2">抹角</el-radio>
          <el-radio :value="3">四舍五入到角</el-radio>
          <el-radio :value="4">四舍五入到元</el-radio>
        </el-radio-group>
      </div>
    ...
    watch: {
      is_money: function(n, o) {
        if (n != o) {
          ...
          if (n) {
            this.money = this.cartInfo.total_pay_price;
            this.type = 1;
            this.rate = 10;
            this.discountType = 1;
          }

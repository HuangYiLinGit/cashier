		...
		<el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" label-width="0px"
			...
			<el-form-item prop="account">
				<div class="left-img-input"><img class="l-img" src="@/assets/img/login-name.png">
					<el-input class="l-input" type="text" v-model="ruleForm2.account" auto-complete="off"
						placeholder="账号">
					</el-input>
				</div>
			</el-form-item>
			<el-form-item prop="checkPass">
				<div class="left-img-input"><img class="l-img" src="@/assets/img/login-password.png">
					<el-input class="l-input" type="password" v-model="ruleForm2.checkPass" auto-complete="off"
						placeholder="密码">
					</el-input>
				</div>
			</el-form-item>
			...
			<el-form-item>
    			<el-checkbox v-model="remember_me" label="记住用户名和密码" size="small" />
			</el-form-item>
			<!-- 验证码暂时不能适配-->
			...
			if (remember_me === 'true') {
				...
				if (accountStr) {
					try {
						...
						this.ruleForm2.account = account.account || '';
						this.ruleForm2.checkPass = account.checkPass || '';
					} catch (e) {

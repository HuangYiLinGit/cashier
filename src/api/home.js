...
let HomeApi = {
	...
	/*基础配置*/
	getOrderBuy(data, errorback) {
		return request._get('/cashier/order.order/buy', data, errorback);
	},
	...
	/* 修改计重商品重量*/
	changeWeight(data, errorback) {
		return request._post('/cashier/order.cart/changeWeight', data, errorback);
	},
	/* 折扣抹零*/
	...
	getTableOrder(data, errorback) {
		return request._get('/cashier/order.Order/orderDetail', data, errorback);
	},
	...
	goodsDetail(data, errorback) {
		return request._get('/cashier/product.product/goodsDetail', data, errorback);
	},
	productDetail(data, errorback) {
		return request._get('/cashier/product.product/detail', data, errorback);
	},
}
